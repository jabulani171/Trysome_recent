...
import { PublishResponseOptions } from "node-opcua-types";
...
export interface IClosedOrTransferedSubscription {
    readonly hasPendingNotifications: boolean;
    dispose(): void;
    readonly id: number;
    _publish_pending_notifications(): void;
}
export declare class TransferedSubscription implements IClosedOrTransferedSubscription {
    id: number;
    publishEngine: any;
    _pending_notifications: InternalNotification[];
