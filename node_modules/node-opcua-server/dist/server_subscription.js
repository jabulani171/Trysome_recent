...
function _adjust_maxNotificationsPerPublish(maxNotificationsPerPublish) {
    ...
    node_opcua_assert_1.assert(util_1.isNumber(maxNotificationsPerPublish));
...
class Subscription extends events_1.EventEmitter {
    ...
    notifyTransfer() {
        ...
        if (this.publishEngine.pendingPublishRequestCount) {
            ...
            const ts = new i_server_side_publish_engine_1.TransferedSubscription({
    ...
    _addNotificationMessage(notificationData) {
        node_opcua_assert_1.assert(util_1.isArray(notificationData));
        ...
        node_opcua_assert_1.assert(util_1.isObject(notificationData[0]));
    ...
    _createMonitoredItemStep3(monitoredItem, monitoredItemCreateRequest) {
        ...
        node_opcua_assert_1.assert(util_1.isFunction(monitoredItem.samplingFunc));
