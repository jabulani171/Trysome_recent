...
class ServerEngine extends events_1.EventEmitter {
    ...
    read(context, readRequest) {
        ...
        for (let i = 0; i < nodesToRead.length; i++) {
            ...
            if ((timestampsToReturn === node_opcua_service_read_1.TimestampsToReturn.Both || timestampsToReturn === node_opcua_service_read_1.TimestampsToReturn.Server) &&
                (!dataValues[i].serverTimestamp || dataValues[i].serverTimestamp === node_opcua_date_time_1.minOPCUADate)) {
    ...
    historyRead(context, historyReadRequest, callback) {
        ...
        async.eachSeries(nodesToRead, (historyReadValueId, cbNode) => {
            this._historyReadSingleNode(context, historyReadValueId, historyReadDetails, timestampsToReturn, (err, result) => {
                if (err && !result) {
