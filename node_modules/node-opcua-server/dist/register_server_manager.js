...
function constructRegisteredServer(server, isOnline) {
    ...
    const s = {
        ...
        serverNames: [{ locale: "en-US", text: server.serverInfo.applicationName.text }],
...
class RegisterServerManager extends events_1.EventEmitter {
    ...
    _establish_initial_connection(outer_callback) {
        ...
        client.on("backoff", (nbRetry, delay) => {
            ...
            console.log(chalk.bgWhite.cyan("contacting discovery server backoff "), this.discoveryServerEndpointUrl, " attempt #", nbRetry, " retrying in ", delay / 1000.0, " seconds");
