...
class ServerSession extends events_1.EventEmitter {
    constructor(parent, sessionTimeout) {
        ...
        node_opcua_assert_1.assert(isFinite(sessionTimeout));
    ...
    createSubscription(parameters) {
        ...
        node_opcua_assert_1.assert(!parameters.hasOwnProperty("id"));
    ...
    _detach_channel() {
        ...
        node_opcua_assert_1.assert(typeof this.channel_abort_event_handler === "function");
    ...
    _createSessionObjectInAddressSpace() {
                ...
                */
                ...
                Object.defineProperty(this._sessionSecurityDiagnostics, "securityMode", {
                    get() {
                        ...
                        return session === null || session === void 0 ? void 0 : session.channel.endpoint.securityMode;
                    }
                });
                Object.defineProperty(this._sessionSecurityDiagnostics, "securityPolicyUri", {
                    get() {
                        const session = this.$session;
                        return session === null || session === void 0 ? void 0 : session.channel.endpoint.securityPolicyUri;
                    }
                });
        ...
        function createSubscriptionDiagnosticsArray() {
            ...
            this.subscriptionDiagnosticsArray = node_opcua_address_space_1.createExtObjArrayNode(this.sessionObject, {
