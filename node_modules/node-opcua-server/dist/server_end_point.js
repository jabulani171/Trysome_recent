...
class OPCUAServerEndPoint extends events_1.EventEmitter {
    constructor(options) {
        ...
        node_opcua_assert_1.assert(typeof this.port === "number");
        ...
        node_opcua_assert_1.assert(this.serverInfo !== null && typeof this.serverInfo === "object");
    }
    dispose() {
    ...
    _un_pre_registerChannel(channel) {
        ...
        node_opcua_assert_1.assert(typeof channel._unpreregisterChannelEvent === "function");
    ...
    shutdown_channel(channel, inner_callback) {
        node_opcua_assert_1.assert(typeof inner_callback === "function");
        channel.once("close", () => {
...
function _makeEndpointDescription(options) {
    node_opcua_assert_1.assert(isFinite(options.port), "expecting a valid port number");
    ...
    node_opcua_assert_1.assert(options.server !== null && typeof options.server === "object");
    node_opcua_assert_1.assert(!!options.hostname && typeof options.hostname === "string");
    node_opcua_assert_1.assert(typeof options.restricted === "boolean");
    ...
    options.securityLevel =
        options.securityLevel === undefined
            ...
            : options.securityLevel;
    node_opcua_assert_1.assert(isFinite(options.securityLevel), "expecting a valid securityLevel");
