...
function registerBasicType(schema) {
    ...
    node_opcua_assert_1.assert(typeof t.decode === "function");
    const encodeFunc = schema.encode || t.encode;
    node_opcua_assert_1.assert(typeof encodeFunc === "function");
    const decodeFunc = schema.decode || t.decode;
    node_opcua_assert_1.assert(typeof decodeFunc === "function");
