...
exports.DataType_toString = exports.UADataType = void 0;
/**
...
class UADataType extends base_node_1.BaseNode {
    ...
    getEncodingDefinition(encoding_name) {
        ...
        const dataValue = descriptionNode.readValue(source_1.SessionContext.defaultContext, indexRange);
    ...
    getEncodingNode(encoding_name) {
        ...
        if (_cache[key] === undefined) {
            node_opcua_assert_1.assert(encoding_name === "Default Binary" || encoding_name === "Default XML" || encoding_name === "Default JSON");
    ...
    _getEnumerationInfo() {
        ...
        if (this.enumStrings) {
            ...
            node_opcua_assert_1.assert(Array.isArray(enumStrings));
            ...
            node_opcua_assert_1.assert(Array.isArray(enumValues));
