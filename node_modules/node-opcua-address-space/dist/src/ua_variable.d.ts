...
import { BindVariableOptions, ContinuationPoint, DataValueCallback, HistoricalDataConfiguration, IVariableHistorian, Permissions, UAVariable as UAVariablePublic, UAVariableType } from "../source";
...
export declare function adjust_accessLevel(accessLevel: any): AccessLevelFlag;
export declare function adjust_userAccessLevel(userAccessLevel: any, accessLevel: any): AccessLevelFlag;
