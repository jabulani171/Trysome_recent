...
exports.initialize_properties_and_components = exports.assertUnusedChildBrowseName = exports.UAVariableType = void 0;
/**
...
class MandatoryChildOrRequestedOptionalFilter {
    constructor(instance, optionalsMap) {
        ...
        node_opcua_assert_1.assert(optionalsMap !== null && typeof optionalsMap === "object");
...
function assertUnusedChildBrowseName(addressSpace, options) {
    ...
    node_opcua_assert_1.assert(parent !== null && typeof parent === "object");
...
function _remove_unwanted_ref(references) {
    ...
    references = references.filter((reference) => !node_opcua_nodeid_1.sameNodeId(reference.referenceType, hasTypeDefinitionNodeId) &&
...
function reconstructNonHierarchicalReferences(extraInfo) {
    ...
    //
    Object.values(extraInfo.mapOrgToClone).forEach((value) => {
