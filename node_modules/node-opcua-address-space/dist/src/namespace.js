...
class UANamespace {
    ...
    addMultiStateDiscrete(options) {
        ...
        const variable = namespace.addVariable(Object.assign(Object.assign({}, options), { dataType: "UInteger", typeDefinition: multiStateDiscreteType.nodeId, value: new node_opcua_variant_1.Variant({
    ...
    addMultiStateValueDiscrete(options) {
        ...
        const cloned_options = Object.assign(Object.assign({}, options), { dataType: "Number", typeDefinition: multiStateValueDiscreteType.nodeId, 
            // valueRank:
            // note : OPCUA Spec 1.03 specifies -1:Scalar (part 8 page 8) but nodeset file specifies -2:Any
            value: new node_opcua_variant_1.Variant({ dataType: node_opcua_variant_1.DataType.UInt32, value: options.value }), valueRank: -1 // -1 : Scalar
         });
    ...
    addTwoStateDiscrete(options) {
        ...
        node_opcua_assert_1.assert(dataValueVerif.value.dataType === node_opcua_variant_1.DataType.Boolean);
        const handler = variable.handle_semantic_changed.bind(variable);
        ua_data_item_1.add_dataItem_stuff(variable, options);
        const trueStateNode = namespace.addVariable({
            ...
            value: new node_opcua_variant_1.Variant({
                dataType: node_opcua_variant_1.DataType.LocalizedText,
                value: node_opcua_data_model_1.coerceLocalizedText(options.trueState || "ON")
            })
        });
        ...
        const falseStateNode = namespace.addVariable({
            ...
            value: new node_opcua_variant_1.Variant({
                dataType: node_opcua_variant_1.DataType.LocalizedText,
                value: node_opcua_data_model_1.coerceLocalizedText(options.falseState || "OFF")
            })
        });
