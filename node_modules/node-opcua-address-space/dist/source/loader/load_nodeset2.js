...
function makeEnumDefinition(definitionFields) {
    return new node_opcua_types_2.EnumDefinition({
...
function makeStructureDefinition(name, definitionFields, isUnion) {
    ...
    const structureType = isUnion
        ? node_opcua_types_2.StructureType.Union
        : hasOptionalFields
            ? node_opcua_types_2.StructureType.StructureWithOptionalFields
            : node_opcua_types_2.StructureType.Structure;
    const sd = new node_opcua_types_2.StructureDefinition({
...
function makeStuff(addressSpace) {
    ...
    const Range_parser = {
        Range: {
            init() {
                this.range = new node_opcua_types_2.Range({});
            },
            parser: {
                Low: {
                    finish() {
            ...
            finish() {
                ...
                switch (self.typeDefinitionId.toString()) {
                    ...
                    case "ns=0;i=7616": // EnumValueType
                        ...
                        node_opcua_assert_1.assert(self.extensionObject !== null && typeof self.extensionObject === "object");
    ...
    function terminate(callback) {
        ...
        if ((_c = (_b = (_a = addressSpace.rootFolder) === null || _a === void 0 ? void 0 : _a.objects) === null || _b === void 0 ? void 0 : _b.server) === null || _c === void 0 ? void 0 : _c.namespaceArray) {
