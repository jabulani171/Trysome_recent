...
function construct_demo_alarm_in_address_space(test, addressSpace) {
    ...
    node_opcua_assert_1.assert(tank.getNotifiers().length === 0, "expecting a notifier now");
    ...
    node_opcua_assert_1.assert(tankLevelCondition.browseName.toString() === "1:TankLevelCondition");
    node_opcua_assert_1.assert(tankLevel.findReferences("HasCondition").length === 1);
    node_opcua_assert_1.assert(tankLevel.findReferencesAsObject("HasCondition", true).length === 1);
    ...
    node_opcua_assert_1.assert(tankLevel2.findReferences("HasCondition").length === 1);
    node_opcua_assert_1.assert(tankLevel2.findReferencesAsObject("HasCondition", true).length === 1);
