...
function MygetExecutableFlag(method, toState, methodName) {
    const stateMachineW = __1.promoteToStateMachine(method.parent);
...
function createBoilerType(namespace) {
    ...
    node_opcua_assert_1.assert(ftx1.output.browseName.toString() === `${namespace.index}:Output`);
    ...
    node_opcua_assert_1.assert(boilerType.inputPipe.flowTransmitter);
    node_opcua_assert_1.assert(boilerType.inputPipe.flowTransmitter.output);
    node_opcua_assert_1.assert(boilerType.flowController.measurement);
...
function makeBoiler(addressSpace, options) {
    ...
    __1.promoteToStateMachine(boiler1.simulation);
    ...
    const context = __1.SessionContext.defaultContext;
