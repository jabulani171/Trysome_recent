...
class MessageChunker {
    ...
    update(options) {
        ...
        node_opcua_assert_1.assert(options.securityHeader !== null && typeof options.securityHeader === "object");
    ...
    chunkSecureMessage(msgType, options, message, messageChunkCallback) {
        node_opcua_assert_1.assert(typeof messageChunkCallback === "function");
        ...
        chunkManager
            ...
            if (doTraceChunk) {
                ...
                console.log(node_opcua_utils_1.timestamp(), "   <$$ ", msgType, "nbChunk = " + nbChunks.toString().padStart(3), "totalLength = " + totalSize.toString().padStart(8), "l=", binSize.toString().padStart(6));
            }
