...
class NodeCrawlerBase extends events_1.EventEmitter {
    constructor(session) {
        ...
        node_opcua_assert_1.assert(typeof session.browse === "function");
        node_opcua_assert_1.assert(typeof session.read === "function");
        this.browseNameMap = {};
        this._objectCache = {};
        this._objMap = {};
    ...
    crawl(nodeId, userData, ...args) {
        ...
        node_opcua_assert_1.assert(typeof endCallback === "function");
    ...
    _inner_crawl(nodeId, userData, endCallback) {
        node_opcua_assert_1.assert(userData !== null && typeof userData === "object");
        node_opcua_assert_1.assert(typeof endCallback === "function");
    ...
    _add_crawl_task(cacheNode, userData) {
        ...
        node_opcua_assert_1.assert(this !== null && typeof this === "object");
        node_opcua_assert_1.assert(this._crawled !== null && typeof this._crawled === "object");
    ...
    _defer_browse_node(cacheNode, referenceTypeId, actionOnBrowse) {
        this.pendingBrowseTasks.push({
            action: (object) => {
                ...
                node_opcua_assert_1.assert(Array.isArray(object.references));
    ...
    _process_single_browseResult2(_objectToBrowse) {
        const cacheNode = _objectToBrowse.cacheNode;
        cacheNode.references = private_1.dedup_reference(cacheNode.references);
