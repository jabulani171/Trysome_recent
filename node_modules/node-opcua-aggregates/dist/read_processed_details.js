...
function readProcessedDetails(variable, context, historyReadDetails, indexRange, dataEncoding, continuationPoint, callback) {
    ...
    const aggregateType = historyReadDetails.aggregateType || [];
    ...
    for (let i = 0; i < aggregateType.length; i++) {
        switch (aggregateType[0].value) {
            ...
            default:
                ...
                return callback(null, new node_opcua_service_history_1.HistoryReadResult({ statusCode: node_opcua_status_code_1.StatusCodes.BadAggregateNotSupported }));
        }
    }
}
