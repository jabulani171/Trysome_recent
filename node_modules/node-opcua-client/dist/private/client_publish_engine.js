...
class ClientSidePublishEngine {
    ...
    suspend(suspendedState) {
        node_opcua_assert_1.assert(this.isSuspended !== !!suspendedState, "publishEngine: invalid state");
    ...
    registerSubscription(subscription) {
        ...
        node_opcua_assert_1.assert(typeof subscription.onNotificationMessage === "function");
