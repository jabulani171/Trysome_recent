...
export declare class ClientSessionImpl extends EventEmitter implements ClientSession {
    ...
    processTransactionQueue: (request: Request, callback: (err: Error | null, response?: import("node-opcua-types").CreateSessionResponse | import("node-opcua-types").ActivateSessionResponse | import("node-opcua-types").CloseSessionResponse | import("node-opcua-service-endpoints").GetEndpointsResponse | ReadResponse | BrowseResponse | BrowseNextResponse | WriteResponse | CallResponse | TranslateBrowsePathsToNodeIdsResponse | CreateSubscriptionResponse | DeleteSubscriptionsResponse | TransferSubscriptionsResponse | CreateMonitoredItemsResponse | ModifyMonitoredItemsResponse | ModifySubscriptionResponse | SetMonitoringModeResponse | PublishResponse | RepublishResponse | DeleteMonitoredItemsResponse | SetPublishingModeResponse | import("node-opcua-types").FindServersOnNetworkResponse | import("node-opcua-types").FindServersResponse | HistoryReadResponse | RegisterNodesResponse | UnregisterNodesResponse | QueryFirstResponse | import("node-opcua-service-query").QueryNextResponse | undefined) => void) => void;
