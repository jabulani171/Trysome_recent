...
class ClientMonitoredItemGroupImpl extends events_1.EventEmitter {
    constructor(subscription, itemsToMonitor, monitoringParameters, timestampsToReturn) {
        super();
        node_opcua_assert_1.assert(Array.isArray(itemsToMonitor));
    ...
    terminate(...args) {
        const done = args[0];
        node_opcua_assert_1.assert(!done || typeof done === "function");
     ...
     */
    _monitor(done) {
        node_opcua_assert_1.assert(done === undefined || typeof done === "function");
